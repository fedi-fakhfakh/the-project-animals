...
let breed_w_anml_available=[[['cat'],['dog']],[['Sphynx cat','British Shorthai'],['doggyyy']]]
...
for(let i=0;i < document.querySelectorAll('.animal-adoption').length;i++){
  popInfo(document.querySelectorAll('.animal-adoption')[i].getAttribute('name'))   
}
...
function showAnimalsa(){
  ...
  final_result_of_elimination()
  console.log(document.querySelectorAll('.animal-adoption'))
}
...
function final_result_of_elimination(){
  ...
  for(let i=0;i < document.querySelector('.main-section-in-animal-adoption').childNodes.length;i++){
    console.log(document.querySelector('.main-section-in-animal-adoption').childNodes)
    document.querySelector('.main-section-in-animal-adoption').childNodes[i].childNodes[0].addEventListener('click',function(){
  ...
  console.log(document.querySelectorAll('.animal-adoption2'))
for(let i=0;i < document.querySelectorAll('.animal-adoption2').length;i++){
  console.log('yeah')
  document.querySelectorAll('.animal-adoption2')[i].childNodes[0].addEventListener('click',function(){
    console.log('yeaaah')
    //if(document.querySelectorAll('.animal-adoption_img')[i].parentElement.getAttribute('class') == 'animal-adoption2'){
      for(let j=0;j < document.querySelectorAll('.parent_of_info_about_the_animal').length;j++){
        if(document.querySelectorAll('.parent_of_info_about_the_animal')[j].style.display == 'block'){
          //console.log(document.querySelectorAll('.parent_of_info_about_the_animal')[j])
          document.querySelectorAll('.parent_of_info_about_the_animal')[j].style.display='none'
          //console.log(document.querySelectorAll('.parent_of_info_about_the_animal')[document.querySelectorAll('.animal-adoption2')[i].getAttribute('name')-1])
  
        }
      } 
      setTimeout(function(){document.querySelectorAll('.parent_of_info_about_the_animal')[document.querySelectorAll('.animal-adoption2')[i].getAttribute('name')-1].style.display='block'},500) 
  })
}
...
for(let i=0;i < document.querySelectorAll('.bx-bookmark').length;i++){
  document.querySelectorAll('.bx-bookmark')[i].addEventListener('click',function(){
    if(pos_user == undefined){
      document.querySelectorAll('.bx-bookmark')[i].classList.add('error')
      document.querySelector('.alertb').classList.remove('alertn')
      if(document.querySelectorAll('.bx-bookmark')[i].classList[document.querySelectorAll('.bx-bookmark')[i].classList.length-1] == 'error'){
       setTimeout(function(){document.querySelectorAll('.bx-bookmark')[i].classList.remove('error')}, 100)
      ...
      for(let j=0;j < document.querySelectorAll('.animal-adoption2').length;j++){
        if(document.querySelectorAll('.animal-adoption2')[j].getAttribute('name') == document.querySelectorAll('.bx-bookmark')[i].parentElement.parentElement.getAttribute('name')){
...
//for(let i=0;i < document.querySelectorAll('.animal-adoption').length;i++){
 //document.querySelector('.main-section-in-animal-adoption').addEventListener('click',function(){
 //  console.log(document.querySelectorAll('.parent_of_info_about_the_animal')[0])
 //  parent_of_info_about_the_animal_all[0].style.display='block'
 //})
//  fa_close_all[i].addEventListener('click',function(){
//    console.log(parent_of_info_about_the_animal_all[i])
